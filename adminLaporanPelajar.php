        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <div style="background: #1a3c63;padding: 2%;">
                    <h1 class="text-center" style="font-weight: bold;font-size: 50px;color: rgb(255,255,255);">Laporan Pelajar</h1>
                </div>
                                            ...
                                            <table class="table my-0" id="dataTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['EMEL_PELAJAR']; ?></td>
                                                        <td><?php echo $row['KATA_LALUAN_PELAJAR']; ?></td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>
