        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <div style="background: #1a3c63;padding: 2%;">
                    <h1 class="text-center" style="font-weight: bold;font-size: 50px;color: rgb(255,255,255);">Senarai Guru</h1>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-xxl-12 offset-xxl-0">
                            <form class="border rounded shadow" style="padding: 10%;">
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col"><a class="btn btn-primary float-end" href = "adminPendaftaranGuru.php" type="button">Tambah Guru</a></div>
                                        </div>  
                                        <?php
                                            ...
                                            <table class="table my-0 mydatatable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['KAD_PENGENALAN'];  //$_SESSION["idguru"]=  $row["ID_GURU"];?></td>
                                                        <td><a type="button" class="btn" href = "./adminMaklumatGuru.php?idguru=<?php echo $row["ID_GURU"];?>" style="margin-right: 3px;color: var(--bs-white);background: rgb(78,115,223);border-color: var(--bs-blue);">Maklumat Guru</a></td>
                                                        <td><a type="button" class="btn" href = "./adminGuruSubjek.php?idguru=<?php echo $row["ID_GURU"]; ?>" style="margin-right: 3px;color: var(--bs-white);background: rgb(78,115,223);border-color: var(--bs-blue);">Daftar Subjek</a></td>
                                                        <td class="w3-right-align"><a class="btn btn-success" href="./adminKemaskiniGuru.php?subId=<?php echo $row["ID_GURU"];?>" style="margin-right: 3px;color: var(--bs-white);">Kemaskini</a><a class="btn btn-danger" href= "./adminBuangGuru.php?subId=<?php echo $row["ID_GURU"]; ?> " style="margin-right: 3px;">Buang</a></td><?php ?>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>
