                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM pelajar  WHERE ID_PELAJAR = ".$_SESSION["idpelajar"]."";
                                            $stmt = $conn->query($sql);
                                             $i = 0;
                                        ?>
                                        ...
                                        <td class="form-group"><a type="button" class="btn btn-success btn-lg float-right" href = "./adminMaklumatPenjaga.php?idpelajar=<?php echo $row["ID_PELAJAR"];?>" style="float-right: 3px;color: var(--bs-white);background: rgb(78,115,223);border-color: var(--bs-blue);">Maklumat Penjaga</a>
