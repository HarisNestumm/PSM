                            ...
                            <form class="border rounded shadow" style="padding: 10%;">
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <td class="float-end btn-toolbar"><a type="button" class="btn" href = "./adminMaklumatPelajar.php?idpelajar=<?php echo $row["ID_PELAJAR"];?>" style="margin-right: 3px;color: var(--bs-white);background: rgb(78,115,223);border-color: var(--bs-blue);">Kembali</a>
