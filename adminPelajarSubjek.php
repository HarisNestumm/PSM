...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(!empty($_POST['check_subjek'])){
        foreach($_POST['check_subjek'] as $checked){
            //var_dump($checked);
            $sql = "INSERT INTO pelajar_subjek(ID_PELAJAR, ID_SUBJEK)
                VALUES(:ID_PELAJAR, :ID_SUBJEK)";
                $stmt = $conn->prepare($sql);
                $stmt->bindParam(":ID_PELAJAR", $_SESSION["idp"]);
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <div style="background: #1a3c63;padding: 2%;">
                    <h1 class="text-center" style="font-weight: bold;font-size: 50px;color: rgb(255,255,255);">Subjek Pelajar</h1>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-xxl-12 offset-xxl-0">
                            <div class="border rounded shadow" style="padding: 10%;">
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                    <form class="text-nowrap" method="post" action="./adminPelajarSubjek.php?idpelajar=<?php echo $_SESSION["idp"]; ?>">
                                        <div class="row">
                                            <?php   
                                                ...
                                                //$sql1 = "SELECT "
                                            ?>
                                                <input class="d-none" type="text" name="idpelajar" value="<?php echo $idp; ?>" readonly>
                                        ...
                                        <div class="table-responsive table mt-2" id="dataTable-3" role="grid" aria-describedby="dataTable_info">
                                            <table class="table my-0" id="dataTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                     $sql = "SELECT  s.ID_SUBJEK, s.NAMA_SUBJEK, ps.ID_SUBJEK, ps.ID_PELAJAR_SUBJEK 
                                                     FROM subjek s, pelajar_subjek ps WHERE s.ID_SUBJEK = ps.ID_SUBJEK AND ps.ID_PELAJAR=".$_SESSION["idp"]."";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="float-end btn-toolbar"><a class="btn btn-danger" href= "./adminBuangPelajarSubjek.php?idpelajarsubjek=<?php echo $row["ID_PELAJAR_SUBJEK"]; ?> " style="margin-right: 3px;">Buang</a></td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>
