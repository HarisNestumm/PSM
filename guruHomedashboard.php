                ...
                <div class="container">
                    <form class="border rounded shadow" style="padding: 10%;">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                        <div class="row">
                                            <div class="col"><a class="btn btn-primary float-end" href = "guruCiptaPengumuman.php" type="button">Cipta Pengumuman</a></div>
                                        </div>
                                        ...
                                        <table class="table my-0 mydatatable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td class=""><a type="button" class="btn" href = "./<?php echo $row['DOKUMEN'];?> " target="_blank" style="margin-right: 3px;color: var(--bs-white);background: rgb(78,115,223);border-color: var(--bs-blue);">Fail Pengumuman</a></a>
                                                       <td class=""><a class="btn btn-success" href="./guruKemaskiniPengumuman.php?subId=<?php echo $row["ID_PENGUMUMAN"];?>" style="margin-right: 3px;color: var(--bs-white);">Kemaskini</a><a class="btn btn-danger" href= "./guruBuangPengumuman.php?subId=<?php echo $row["ID_PENGUMUMAN"];?>" style="margin-right: 3px;">Buang</a></td>
