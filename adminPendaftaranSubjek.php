<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "INSERT INTO subjek (NAMA_SUBJEK, ID_ADMIN) VALUES (:NAMA_SUBJEK, 1)";
                ...
                <div class="row">
                    <div class="col-xxl-8 offset-xxl-2">
                        <form class="border rounded shadow" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" style="padding: 10%;">
                            <div><label class="form-label">Nama Subjek:</label><input class="form-control" name = "NamaSubjek" type="text"></div><br>
