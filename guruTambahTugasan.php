...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    $sql2 = "INSERT INTO tugasan_guru(ID_GURU, ID_SUBJEK, TAJUK, TUGASAN, TARIKH)
            VALUES (:ID_GURU, :ID_SUBJEK, :TAJUK, :TUGASAN, :TARIKH)";
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small"><label><?php echo $namaguru;?></label></span><img class="border rounded-circle img-profile" src="assets/img/boy.jpg"></a>
                                    <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in"><a class="dropdown-item" href="guruProfail.php"><i class="fas fa-user fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Profile</a>
                ...
                <form class="border rounded shadow" method = "POST" action = "<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" style="padding: 10%; ">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 fw-bold">Tambah Tugasan</p>
                            </div>
                            <div class="card-body">
                            ...
                            <div><input class="d-none" name="id" value="<?php { echo $_GET['subId'];} ?>"><label class="form-label">Tajuk Tugasan:</label><input class="form-control" name = "Tajuk" type="text" value="<?php //echo $row['TAJUK_BAHAN'];} ?>"></div><br>
                                ...
                                <div><label class="form-label">Tugasan</label><input class="form-control" name = "Tugasan" type="file"></div><br>
