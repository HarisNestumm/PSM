        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <div style="background: #1a3c63;padding: 2%;">
                    <h1 class="text-center" style="font-weight: bold;font-size: 50px;color: rgb(255,255,255);">Senarai Pelajar</h1>
                </div>
                <div class="container">
                    <div class="row">
                            ...
                            <form class="border rounded shadow" style="padding: 10%;">
                                <div class="card shadow">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 fw-bold">Info Pelajar</p>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col"><a class="btn btn-primary float-end" href = "adminPendaftaranPelajar.php" type="button">Tambah Pelajar</a></div>
                                        </div>  
                                        <?php
                                            ...
                                            <table class="table my-0 mydatatable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a type="button" class="btn" href = "./adminMaklumatPelajar.php?idpelajar=<?php echo $row["ID_PELAJAR"];?>" style="margin-right: 3px;color: var(--bs-white);background: rgb(78,115,223);border-color: var(--bs-blue);">Maklumat Pelajar</a></td>
                                                        <td><a type="button" class="btn" href = "./adminPelajarSubjek.php?idpelajar=<?php echo $row["ID_PELAJAR"];?>" style="margin-right: 3px;color: var(--bs-white);background: rgb(78,115,223);border-color: var(--bs-blue);">Daftar Subjek</a>
                                                        <td class="w3-right-align"><a class="btn btn-success" href="./adminKemaskiniPelajar.php?idpelajar=<?php echo $row["ID_PELAJAR"];?>" style="margin-right: 3px;color: var(--bs-white);">Kemaskini</a><a class="btn btn-danger" href= "./adminBuangPelajar.php?pelajarDanPenjaga=<?php echo $row["ID_PELAJAR"];?>" style="margin-right: 3px;">Buang</a></td>
