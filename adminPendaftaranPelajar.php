...
if(isset($_POST['NamaPelajar']) && isset($_POST['UmurPelajar']) && isset($_POST['TarikhLahirPelajar']) 
 && isset($_POST['MyKid']) && isset($_POST['Jantina']) && isset($_POST['Agama']) && isset($_POST['Bangsa'])){
    ...
    header("Location: ./adminPendaftaranPelajarPenjaga.php");
     }
    else
    {
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xxl-8 offset-xxl-2">
                            <form class="border rounded shadow" method = "POST" action = "./adminPendaftaranPelajar.php" style="padding: 10%;">
                                <div><label class="form-label">Nama Penuh:</label><input class="form-control" name = "NamaPelajar" type="text"></div><br>
                                <div><label class="form-label">Umur:</label><input class="form-control" name = "UmurPelajar" type="text"></div><br>
                                <div><label class="form-label">Tarikh Lahir:</label><input class="form-control" name = "TarikhLahirPelajar" type="date"></div><br>
                                <div><label class="form-label">No. MyKid:</label><input class="form-control" name = "MyKid" type="text"></div><br>
                                ...
                                <div><button class="btn btn-secondary float-start" type="reset">Set Semula</button><button class="btn btn-primary float-end" name = "simpanseterusnya" type="submit">Seterusnya</button></div>
                            </form>
                        </div>
                    </div>
                </div>
