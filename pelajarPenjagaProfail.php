        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div style="background: #1a3c63;padding: 2%;">
                    <h1 class="text-center" style="font-weight: bold;font-size: 50px;color: rgb(255,255,255);">Profail Penjaga Pelajar</h1>
                </div>
                <div class="container">
                <form class="border rounded shadow" method = "POST" action = "<?php echo $_SERVER['PHP_SELF']?>;" style="padding: 10%;">
                        <div class="card shadow">
                            <div class="card-header py-3">
                               <p class="text-primary m-0 fw-bold">info Penjaga Pelajar</p>
                            </div>
                            <div class="card-body">
                            <div class="card-body">
                                    
                                        <?php
                                            //$sql = "SELECT ID_GURU, NAMA_GURU, UMUR, KAD_PENGENALAN, JANTINA, AGAMA, BANGSA, NO_TEL FROM guru WHERE ID_GURU = "
                                            $sql = "SELECT * FROM penjaga_pelajar WHERE ID_PELAJAR = ".$_SESSION["idpelajar"]." ";
                                            $stmt = $conn->query($sql);
                                        ...
                                        <div class="table-responsive table mt-2" id="dataTable-3" role="grid" aria-describedby="dataTable_info">
                                            ...
                                            <tbody>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                    <td class="form-group"><a type="button" class="btn btn-success btn-lg float-right" href = "./pelajarProfail.php?idpelajar=<?php echo $row["ID_PELAJAR"];?>" style="float-right: 3px;color: var(--bs-white);background: rgb(78,115,223);border-color: var(--bs-blue);">Kembali</a>
