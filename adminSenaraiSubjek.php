                    ...
                    <li class="nav-item d-flex justify-content-center align-items-center">
                        <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle active" aria-expanded="false" data-bs-toggle="dropdown" href="#">&nbsp;<img class="rounded-circle" src="assets/img/boy.jpg" style="width: 40px;border-width: 2px;border-style: solid;"></a>
                            <div class="dropdown-menu dropdown-menu-end text-start shadow" style="margin-top: 16px;"><a class="dropdown-item" href="#">Pengaturan</a><a class="dropdown-item" href="#">Log Aktivitas</a><a class="dropdown-item" href="#">Pelanggaran</a>
                                <div class="dropdown-divider"></div><a class="dropdown-item" href="logout.php">Log Keluar</a>
                            </div>
                        </div>
                    </li>
                </ul>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <div style="background: #1a3c63;padding: 2%;">
                    <h1 class="text-center" style="font-weight: bold;font-size: 50px;color: rgb(255,255,255);">Senarai Subjek</h1>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-xxl-8 offset-xxl-2">
                            <form class="border rounded shadow" style="padding: 10%;">
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col"><a class="btn btn-primary float-end" href ="adminPendaftaranSubjek.php" type="button">Tambah Subjek</a></div>
                                           
                                        </div>
                                        <div class="table-responsive table mt-2" id="dataTable-3" role ="grid" aria-describedby="dataTable_info">
                                            <table class="table my-0" id="dtBasicExample">
                                                <thead>
                                                    <tr>
                                                        <th></th>
                                                        <th>Bil.</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="float-end btn-toolbar"><a class="btn btn-success" href="./adminKemaskiniSubjek.php?subId=<?php echo $row["ID_SUBJEK"]; ?>" style="margin-right: 3px;color: var(--bs-white);">Kemaskini</a><a class="btn btn-danger" href="./adminBuangSubjek.php?subId=<?php echo $row["ID_SUBJEK"]; ?>" style="margin-right: 3px;">Buang</a></td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>
