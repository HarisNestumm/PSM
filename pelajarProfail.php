        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div style="background: #1a3c63;padding: 2%;">
                    <h1 class="text-center" style="font-weight: bold;font-size: 50px;color: rgb(255,255,255);">Profail Pelajar</h1>
                </div>
                <div class="container">
                                        ...
                                        <div class="table-responsive table mt-2" id="dataTable-3" role="grid" aria-describedby="dataTable_info">
                                            ...
                                            <tbody>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                    <td class="form-group;w3-right-align"><a type="button" class="btn btn-success btn-lg float-right" href = "./pelajarPenjagaProfail.php?idpelajar=<?php echo $row["ID_PELAJAR"];?>" style="float-right: 3px;color: var(--bs-white);background: rgb(78,115,223);border-color: var(--bs-blue);">Maklumat Penjaga</a>
